...
public class E03_EcdhKeyexchangeSignature {

	public static void main(String[] args) throws Exception {
		System.out.println("E03 ECDH Schlüsselaustausch mit Signatur");
		...
		byte[] signatureByte = signPrivateKey(aPrivateKey, ecHashverfahrenString, messageByte);
		System.out.println(
		...
		Boolean signatureIsCorrectBoolean = verifyPublicKey(aPublicKey, ecHashverfahrenString, messageByte, signatureByte);
		System.out.println("Überprüfung der Signatur mit dem publicKey: die Signatur ist korrekt:" + signatureIsCorrectBoolean);
	}

	public static KeyPair generateEcdhKeyPair(String curvenameString)
	...
	public static byte[] createEcdhSharedSecret(PrivateKey privateKey, PublicKey publicKey)
